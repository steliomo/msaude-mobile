...
public class ConsultationDateQueryFilter implements ConsultationQueryFilter {
    ...
    private HealthFacilityDTO fakeData(ConsultationFilter consultationFilter) {
        ...
        HealthFacilityDTO healthFacilityDTO = new HealthFacilityDTO(consultationFilter.getCity(), consultationFilter.getConsultationType(), Arrays.asList(clinica222, clinica222, policlinic));
