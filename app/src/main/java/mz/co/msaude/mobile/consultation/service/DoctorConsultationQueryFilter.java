...
public class DoctorConsultationQueryFilter implements ConsultationQueryFilter {
    ...
    private HealthFacilityDTO fakeData(ConsultationFilter consultationFilter) {
        ...
        HealthFacilityDTO healthFacilityDTO = new HealthFacilityDTO(consultationFilter.getCity(), consultationFilter.getConsultationType(), Arrays.asList(clinicare, hospitalPrivado, clinica222));
