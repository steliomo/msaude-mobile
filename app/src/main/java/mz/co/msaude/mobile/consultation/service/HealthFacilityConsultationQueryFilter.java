...
public class HealthFacilityConsultationQueryFilter implements ConsultationQueryFilter {
    ...
    private DoctorDTO fakeData(ConsultationFilter consultationFilter) {
        ...
        DoctorDTO doctorDTO = new DoctorDTO(consultationFilter.getCity(), consultationFilter.getConsultationType(), clinicare, Arrays.asList(alima, nailah, rui, yolanda, kamilah));
